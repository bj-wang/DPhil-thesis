% GIWAXS data analysis for crystallite texture determination in semicrystalline polymer semiconductor thin films
% Hardware: Rigaku SmartLab (Room 115, Clarendon Laboratory)
...
colourbarmin = 22;              % Minimum value of the colour bar in the exported figure, default = 20
colourbarmax = 280;             % Maximum value of the colour bar in the exported figure, default = 800
...
lambda = 1.540593;              % X-ray wavelength, angstrom
